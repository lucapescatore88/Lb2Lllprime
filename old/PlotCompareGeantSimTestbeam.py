...
#Date : 2015/04/22                                                                                                                                           
#Used to compare cluster observables between the geant 4 'stand-alone' simulation and testbeam data
...
def draw_compare_plot(outputdirectory, outputname, tree1, tree2, observable, geant_observable, title, beginning, end, numbins):
    ...
    leg.AddEntry(histo2,"Testbeam data","l")
...
if __name__ == '__main__':
    ...
    parser.add_argument("-ni", "--nickname" , default="compareGeant4Testbeam" , action="store", type=str)
    parser.add_argument("-d" , "--outputdirectory" , default="" , action="store", type=str)
    parser.add_argument("-i1", "--inputfile1" , default="/eos/lhcb/wg/SciFi/Simulation/Testbeam/GeantSim/20160922/ClusterFile_A_0.root" , action="store", type=str, help = 'Name of the testbeam data file')
    parser.add_argument("-i2", "--inputfile2" , default="/eos/lhcb/wg/SciFi/Simulation/Testbeam/TestbeamData/20160922/posA-angle0_datarun_ntuple_corrected_clusterAnalyis.root" , action="store", type=str, help = 'Name of the simulation file')
